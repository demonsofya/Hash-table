...
list_t ListCtor(int data_size) {
    ...
    list_struct.data = (char **) calloc(sizeof(char*), data_size);
...
void ReallocList(list_t *list_struct, int new_size) {
    ...
    list_struct->data = (char **) realloc(list_struct->data, new_size * sizeof(char *));
...
int InsertAfter(list_t *list_struct, int prev_pos, const char *insert_element, int *new_element_pos) {
...
int InsertBefore(list_t *list_struct, int next_pos, const char *insert_element, int *new_element_pos) {
...
int InsertElement (list_t *list_struct, int prev_pos, int next_pos, const char *insert_element, int *new_element_pos) {

    Return_If_Error(list_struct);

    int curr_pos = GetFreeElementPosition(list_struct);

    list_struct->data[curr_pos] = MyStrDup(insert_element);
    //list_struct->data[curr_pos] = strdup(insert_element);
...
int DeleteElement(list_t *list_struct, int curr_pos, bool *if_element_deleted) {
    ...
    list_struct->data[curr_pos] = NULL;
...
int SortList(list_t *list_struct) {
    ...
    char **new_data = (char **) calloc(list_struct->list_size, sizeof(char *));
