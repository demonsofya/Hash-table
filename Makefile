...
hash_table : main.o list.o list_dump.o hash-table.o hash_table_dump.o
	g++ main.o list.o list_dump.o hash-table.o hash_table_dump.o -o hash_table $(FLAGS)

main.o : main.cpp list/list.h hash-table.h
	g++ main.cpp -c $(FLAGS)
